...
export function BottomNav({
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-[var(--border)] bg-[var(--sidebar)] px-2 py-2 lg:hidden">
          ...
          return (
            <motion.button
              ...
              className={cn(
                ...
                active ? "bg-[rgba(34,211,238,0.10)] text-[var(--primary)]" : "text-[var(--muted)]",
              )}
            >

...
class BaseGearProgram {
    ...
    get accountAddress() {
        if (typeof this._account == 'string') {
            return address.decodeAddress(this._account);
        }
        else if ('address' in this._account) {
            return address.decodeAddress(this._account.address);
        }
        else {
    ...
    async calculateReply(payload, value = 0, gasLimit = 'max') {
        ...
        return {
            ...
            code: new replyCode.ReplyCode(reply.code.toU8a(), this._api.specVersion),
        };
    }
    ...
    _waitForResponseHandler(id, blockNumber) {
        return async () => {
            ...
            return {
                ...
                replyCode: new replyCode.ReplyCode(message.details.unwrap().code.toU8a(), this._api.specVersion),
            };
        };
    }
    /**
...
exports.BaseGearProgram = BaseGearProgram;

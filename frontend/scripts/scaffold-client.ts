...
// Default IDL path: src/assets/tradevault_arena_client.idl
...
async function main() {
  const idlPath = process.argv[2] || resolve(FRONTEND_DIR, "src/assets/tradevault_arena_client.idl");
  ...
  try {
    ...
    console.error(`Expected path: frontend/src/assets/tradevault_arena_client.idl`);
    process.exit(1);
  }
  ...
  const idlRelPath = "src/assets/tradevault_arena_client.idl";
